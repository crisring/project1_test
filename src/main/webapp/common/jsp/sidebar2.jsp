...
<script type="text/javascript">
	function confirmLogout() {
		...
		if (confirm(adminId + "님 로그아웃 하시겠습니까?")) {
			window.location.href = "http://localhost/proejct1/common/jsp/logout.jsp";
		}
	}
</script>
...
<div class="header"
	...
	<span><a href="http://localhost/proejct1/manage/admin_main.jsp">스마트스토어
			센터</a></span>
	<div class="admin_div">
		<span id="admin_id">${userData.admin_id}님</span> <span><input
			type="button" class="logout-btn" value="로그아웃"
			onclick="confirmLogout()" style="border-radius: 10px;"></span>
	</div>
</div>
	...
	<div class="accordion" id="accordionSidebar">
		...
		<div class="accordion-item">
			...
			<div id="collapseOne" class="accordion-collapse collapse"
				...
				<div class="accordion-body">
					<a href="http://localhost/proejct1/manage/product/productList.jsp">상품
						리스트</a> <a
						href="http://localhost/proejct1/manage/product/productRegistration.jsp">상품
						등록</a>
				</div>
			</div>
		</div>
		...
		<div class="accordion-item">
			...
			<div id="collapseTwo" class="accordion-collapse collapse"
				...
				<div class="accordion-body">
					<a href="http://localhost/proejct1/manage/sales/salesList.jsp">판매
						리스트</a>
				</div>
			</div>
		</div>
		...
		<div class="accordion-item">
			...
			<div id="collapseFour" class="accordion-collapse collapse"
				...
				<div class="accordion-body">
					<a
						href="http://localhost/proejct1/manage/inquiry/admin_inquiry.jsp">문의
						리스트</a>
				</div>
			</div>
		</div>
		...
		<div class="accordion-item">
			...
			<div id="collapseFive" class="accordion-collapse collapse"
				...
				<div class="accordion-body">
					<a href="http://localhost/proejct1/manage/review/admin_review.jsp">리뷰
						리스트</a>
				</div>
			</div>
		</div>
		...
		<div class="accordion-item">
			...
			<div id="collapseSix" class="accordion-collapse collapse"
				...
				<div class="accordion-body">
					<a href="http://localhost/proejct1/manage/notice/notice_list.jsp">공지사항
						리스트</a> <a
						href="http://localhost/proejct1/manage/notice/notice_add.jsp">공지사항
						등록</a>
				</div>
			</div>
		</div>
		...
		<div class="accordion-item">
			...
			<div id="collapseSeven" class="accordion-collapse collapse"
				...
				<div class="accordion-body">
					<a href="http://localhost/proejct1/manage/member/memberList.jsp">회원
						목록</a>
				</div>
			</div>
		</div>
