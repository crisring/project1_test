...
<link rel="stylesheet"
	href="http://localhost/proejct1/common/css/footer.css">
<link rel="stylesheet" type="text/css"
			...
			<div class="content-box" id="saleprice-container">
				...
				<div class="price-input">
					<input type="number" id="selling-price" placeholder="숫자만 입력"
						value="<%=pVO.getPrice()%>"> <input type="text" value="원"
				...
				<div class="preview-container">
					...
					<div>
						...
						<img id="mainImagePreview"
							src='<%=pVO.getMainImg() != null ? "http://localhost/proejct1/common/images/" + pVO.getMainImg() : ""%>'
							alt="대표이미지 미리보기"
